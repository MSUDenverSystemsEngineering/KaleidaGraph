...
$adtSession = @{
    # App variables.
    AppVendor = 'Synergy Software'
    AppName = 'Kaleidagraph'
    AppVersion = '5.4'
    AppArch = 'x64'
    AppLang = 'en'
    AppRevision = ''
...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses KaleidaGraph -CheckDiskSpace -PersistPrompt
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath "KaleidaGraph_Network.msi" -ArgumentList '/Quiet /QN' -PassThru
    ...
    Copy-ADTFile -Path "$($adtSession.DirSupportFiles)\*" -Destination 'C:\Program Files\Synergy Software\KaleidaGraph 5.0\' -Recurse
...
function Uninstall-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses KaleidaGraph, iexplorer -PersistPrompt
    ...
    Start-ADTMsiProcess -Action 'Uninstall' -FilePath "KaleidaGraph_Network.msi" -ArgumentList '/Quiet /QN' -PassThru
    ...
    Remove-ADTFolder -Path "C:\Program Files\Synergy Software\"
